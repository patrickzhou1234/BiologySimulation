...
const createScene = function () {
    ...
    camera = new BABYLON.ArcRotateCamera("camera", 80, 1.5, 50, new BABYLON.Vector3.Zero(), scene);
    ...
    BABYLON.SceneLoader.ImportMesh("", "/Heart/model/", "heart.glb", scene, function (meshes) {
