...
const createScene = function () {
    ...
    camera = new BABYLON.ArcRotateCamera("camera", 0, 0, 100, new BABYLON.Vector3.Zero(), scene);
    ...
    BABYLON.SceneLoader.ImportMesh("", "/Neuron/models/", "neuron.glb", scene, function (meshes) {
