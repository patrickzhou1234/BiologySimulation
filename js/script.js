        ...
        BABYLON.SceneLoader.ImportMesh("", "", "models/human.glb", scene, function (meshes) {
            ...
            kidney.actionManager.registerAction(
                new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPickTrigger, function () {
                    ...
                    Swal.fire({
                        title: "Kidney",
                        text: "The kidneys are vital bilateral organs positioned retroperitoneally within the upper abdominal quadrants, with a distinctive bean-like shape characterized by superior and inferior poles. Their primary role within the urinary system is the elimination of excess bodily fluids, salts, and metabolic waste products, playing a pivotal role in regulating acid-base balance, blood pressure, and various other homeostatic parameters. Additionally, kidneys contribute significantly to the body's homeostasis by regulating blood osmolarity and pH, controlling blood volume and pressure, producing essential hormones, and filtering foreign substances. These kidney organs possess anterior and posterior surfaces, with the former facing the anterior abdominal wall and the latter facing the posterior abdominal wall, separated by their lateral convexity and medial concavity. The hilum, located at the center of the minor concavity, serves as the entry point for the renal artery and the exit points for the renal vein and ureter. Positioned retroperitoneally, kidneys are situated behind the peritoneal layers, although they maintain specific relationships with adjacent peritoneal-covered organs. The left kidney is typically positioned slightly higher than the right due to the influence of the liver and stomach on abdominal symmetry. In summary, the kidneys play a pivotal role in maintaining homeostasis through their intricate structure and functions, residing in a protected retroperitoneal position within the abdominal cavity. ",
                        icon: "question",
                        background: "black",
                        color: "white",
                        backdrop: false,
            ...
            lung.actionManager.registerAction(
                new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPickTrigger, function () {
                    ...
                    Swal.fire({
                        title: "Lung",
                        text: "The lungs, integral to the respiratory system, reside symmetrically within the thoracic region, flanking the chest's sides. The right lung consists of three lobes (superior, middle, and inferior), wider but shorter than the left. Both lungs are shielded by pleural tissue. In contrast, the left lung, with two lobes, accommodates the heart, featuring the cardiac notch and lingula. Their primary role involves gas exchange, enabling the body to inhale oxygen and exhale carbon dioxide about 12 to 20 times per minute. Air enters through the nose or mouth, traveling via the pharynx, larynx, and trachea to bronchial tubes, one for each lung. Airways must remain unobstructed for optimal function, free from inflammation or excessive mucus. Bronchial tubes branch into bronchi and bronchioles, leading to alveoli, tiny sacs where oxygen is exchanged with the bloodstream. Oxygen-rich blood returns to the heart for distribution, while carbon dioxide is transported back to the lungs and exhaled. Protective mechanisms include nasal hairs, mucus production, and cilia movement. Notably, one can survive with one lung, and lungs are buoyant. Regular exercise enhances lung capacity, and adults typically possess 300 million to 500 million alveoli. In sum, lungs are vital respiratory components, optimizing gas exchange and exemplifying the body's ingenious design to sustain health and life. ",
                        icon: "question",
                        background: "black",
                        color: "white",
                        backdrop: false,
            ...
            stomach.actionManager.registerAction(
                new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPickTrigger, function () {
                    ...
                    Swal.fire({
                        title: "Stomach",
                        text: "The stomach is a muscular organ that digests food by contractions and production of acids and enzymes. At the same time, it is also part of your gastrointestinal (GI) tract. This is a long tube that starts in one’s mouth and runs to the anus, where stool leaves the body, which is the end of the digestion process. After receiving the food from the esophagus, the J-shaped organ contracts, relaxes, and mixes enzymes and digestive juices to break it down. Then, it passes the digested food to the small intestine for further processing. The stomach is located in the upper abdomen on the left side of your body, and the size varies from person to person, but expands the more food that is eaten. The stomach has five distinct sections: the cardia, fundus, body, antrum, and pylorus. At the top part, the cardia has the cardiac sphincter, which prevents food from traveling back up your esophagus. Next to the cardia is the fundus, also below the diaphragm, stores any gas produced in the digestion process. The largest section, the body, contracts and mixes the food. Below the body, the antrum, stores the food until it is ready to be passed onto the small intestine. Finally, the pylorus includes the pyloric sphincter, and controls when and how your stomach contents move to your small intestine. ",
                        icon: "question",
                        background: "black",
                        color: "white",
                        backdrop: false,
