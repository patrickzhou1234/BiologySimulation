...
function createSphereBtn(depth, verticalpos, horizontalpos, meshesarray, onclick, diameter = 0.25) {
    // Create a standard material for spheres if it doesn't exist
    if (!sharedSphereMaterial) {
        sharedSphereMaterial = new BABYLON.StandardMaterial("sphereMaterial", scene);
        sharedSphereMaterial.diffuseColor = new BABYLON.Color3(0.5, 0.5, 0.5); // grey
        sharedSphereMaterial.specularColor = new BABYLON.Color3(0.2, 0.2, 0.2);
        sharedSphereMaterial.emissiveColor = new BABYLON.Color3(0, 0, 0);
        sharedSphereMaterial.ambientColor = new BABYLON.Color3(0.5, 0.5, 0.5);
    }
    ...
    // Each sphere gets its own material so hover color doesn't affect all
    ...
    sphereMaterial.specularColor = new BABYLON.Color3(0.2, 0.2, 0.2);
    sphereMaterial.emissiveColor = new BABYLON.Color3(0, 0, 0);
    sphereMaterial.ambientColor = new BABYLON.Color3(0.5, 0.5, 0.5);
    ...
    // On hover, gradually increase the size and change color to green
    sphere.actionManager.registerAction(
    ...
    // On hover out, smoothly return to original size and revert color to grey
    sphere.actionManager.registerAction(
        new BABYLON.InterpolateValueAction(
...
function showExteriorBrain() {
    ...
    if (showExterior.textContent == "Show Exterior View") {
        ...
        createSphereBtn(8.43870385928456, -7.669021724662432, -3.3618906969331945, lobemeshes, function () {
            createBasicPopup("Pons", "The pons connects your brainstem with the cerebral cortex, and controls movement and sleep. ");
        }, 2.5);

        createSphereBtn(5.881520530349253, -2.389640943659913, -3.7078067365543674, lobemeshes, function () {
        ...
        createSphereBtn(13, -7, 5, lobemeshes, function () {
        ...
        createSphereBtn(-3.5737458068703276, 9.243767774489436, -11.965853805506342, lobemeshes, function () {
        ...
        createSphereBtn(-3.1009753080826954, -2.0810282693562208, 3.43813110274354, lobemeshes, function () {
        ...
        createSphereBtn(11.218426505672202, 13.035765656995679, -0.6575950891862092, lobemeshes, function () {
        ...
        createSphereBtn(13.991150944003131, 1.2128620511509567, 11.584530010406212, lobemeshes, function () {
...
function loadneuron(val) {
    ...
    if (checkvis(showNeuron) || val == 0) {
        if (showNeuron.textContent == "Show Neuron") {
            ...
            createSphereBtn(0, 2, 0, neuronmeshes, function () {
                camera.lowerRadiusLimit = 2;
            ...
            createSphereBtn(-60, -15, 10, neuronmeshes, function () {
                camera.lowerRadiusLimit = 2;
            ...
            createSphereBtn(-10, 1, 0, neuronmeshes, function () {
                camera.lowerRadiusLimit = 2;
            ...
            createSphereBtn(-23, -2, 0, neuronmeshes, function () {
                camera.lowerRadiusLimit = 2;
                Swal.fire({
            ...
            createSphereBtn(15, 0, 0, neuronmeshes, function () {
                camera.lowerRadiusLimit = 2;
...
scene.clearColor = new BABYLON.Color3(0.25, 0.45, 0.65); // Slightly darker blue background
