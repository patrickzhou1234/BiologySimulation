...
var createScene = function (canvas, engine) {
    ...
    membrane.actionManager.registerAction(
        new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPickTrigger, function () {
            ...
            Swal.fire({
                title: "Cell Membrane",
                text: "The Cell Membrane is composed primarily of a phosopholipid bilayer, with other molecules such as proteins and cholestrol embedded.. Phospholipids have 2 unsaturated fatty acid tails and one head. The phospholipid head is hydrophilic (it is attracted to water) and the 2 unsaturated fatty acid tails are hydrophobic (they repel water). The phospholipid bilayer has many kinks and bends in it. This allows the inside of the membrane to be fluid, meaning it can get more or less solid depending on outside conditions, such as temperature. The fluidity of the membrane is mainly due to the cholestrol. The many proteins embedded have many, many uses, some including being used for transport, attachment, and signaling.",
                icon: "question",
                background: "black",
                color: "white",
