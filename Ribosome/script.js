...
const createScene = function () {
    ...
    camera = new BABYLON.ArcRotateCamera("camera", 20, 10, 1, new BABYLON.Vector3.Zero(), scene);
    ...
    BABYLON.SceneLoader.ImportMesh("", "/Ribosome/models/", "ribosoma.glb", scene, function (meshes) {
